 ...
 * @param {String} type type of addon (message,fill,etc)
 * @param {String} name name of addon
 * @private
 */
BaseDOMConstructor.prototype._getAddon = function(type,name){
    return this.spiral.instancesController.getInstanceAddon(this.name,type,name);
};
